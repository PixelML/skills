...
- macOS: `~/Library/Application Support/agent-skills/gemini-web/consent.json`
- Linux: `~/.local/share/agent-skills/gemini-web/consent.json`
- Windows: `%APPDATA%\agent-skills\gemini-web\consent.json`
...
test -f .agent-skills/danger-gemini-web/EXTEND.md && echo "project"
test -f "${XDG_CONFIG_HOME:-$HOME/.config}/agent-skills/danger-gemini-web/EXTEND.md" && echo "xdg"
test -f "$HOME/.agent-skills/danger-gemini-web/EXTEND.md" && echo "user"
```

```powershell
# PowerShell (Windows)
if (Test-Path .agent-skills/danger-gemini-web/EXTEND.md) { "project" }
$xdg = if ($env:XDG_CONFIG_HOME) { $env:XDG_CONFIG_HOME } else { "$HOME/.config" }
if (Test-Path "$xdg/agent-skills/danger-gemini-web/EXTEND.md") { "xdg" }
if (Test-Path "$HOME/.agent-skills/danger-gemini-web/EXTEND.md") { "user" }
```

┌──────────────────────────────────────────────────────────┬───────────────────┐
│                           Path                           │     Location      │
├──────────────────────────────────────────────────────────┼───────────────────┤
│ .agent-skills/danger-gemini-web/EXTEND.md                │ Project directory │
├──────────────────────────────────────────────────────────┼───────────────────┤
│ $HOME/.agent-skills/danger-gemini-web/EXTEND.md          │ User home         │
└──────────────────────────────────────────────────────────┴───────────────────┘
