...
test -f .agent-skills/translate/EXTEND.md && echo "project"
test -f "${XDG_CONFIG_HOME:-$HOME/.config}/agent-skills/translate/EXTEND.md" && echo "xdg"
test -f "$HOME/.agent-skills/translate/EXTEND.md" && echo "user"
```

```powershell
# PowerShell (Windows)
if (Test-Path .agent-skills/translate/EXTEND.md) { "project" }
$xdg = if ($env:XDG_CONFIG_HOME) { $env:XDG_CONFIG_HOME } else { "$HOME/.config" }
if (Test-Path "$xdg/agent-skills/translate/EXTEND.md") { "xdg" }
if (Test-Path "$HOME/.agent-skills/translate/EXTEND.md") { "user" }
```

| Path | Location |
|------|----------|
| `.agent-skills/translate/EXTEND.md` | Project directory |
| `$HOME/.agent-skills/translate/EXTEND.md` | User home |
