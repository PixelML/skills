...
test -f .agent-skills/post-to-x/EXTEND.md && echo "project"
test -f "${XDG_CONFIG_HOME:-$HOME/.config}/agent-skills/post-to-x/EXTEND.md" && echo "xdg"
test -f "$HOME/.agent-skills/post-to-x/EXTEND.md" && echo "user"
```

```powershell
# PowerShell (Windows)
if (Test-Path .agent-skills/post-to-x/EXTEND.md) { "project" }
$xdg = if ($env:XDG_CONFIG_HOME) { $env:XDG_CONFIG_HOME } else { "$HOME/.config" }
if (Test-Path "$xdg/agent-skills/post-to-x/EXTEND.md") { "xdg" }
if (Test-Path "$HOME/.agent-skills/post-to-x/EXTEND.md") { "user" }
```

|                       Path                       |     Location      |
|--------------------------------------------------|-------------------|
| .agent-skills/post-to-x/EXTEND.md                | Project directory |
| $HOME/.agent-skills/post-to-x/EXTEND.md          | User home         |
